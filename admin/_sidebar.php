<?php
// Admin sidebar partial — included by all admin pages
...
<aside class="admin-sidebar">
  ...
  <nav>
    ...
    <div class="nav-section">
      ...
      <a href="doctors.php" class="nav-item <?= $currentPage==='doctors.php'?'active':'' ?>">
    ...
    <div class="nav-section">
      ...
      <a href="reports.php" class="nav-item <?= $currentPage==='reports.php'?'active':'' ?>">
        <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M18 20V10M12 20V4M6 20v-6"/></svg>
        Reports
      </a>
    </div>
  </nav>
  <div class="sidebar-footer">
    <?php $s_pic = $_SESSION['profile_pic'] ?? null; $s_name = 'Admin'; ?>
    ...
    <div class="info" style="flex:1"><?= htmlspecialchars($s_name) ?><span>Administrator</span></div>
